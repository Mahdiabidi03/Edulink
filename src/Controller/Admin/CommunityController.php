...
class CommunityController extends AbstractController
{
    ...
    public function index(
        ...
        $allReports = $reportRepo->findBy([], ['createdAt' => 'DESC']);
        ...
        $totalComments = (int) $em->createQuery('SELECT COUNT(c.id) FROM App\Entity\PostComment c')->getSingleScalarResult();
        $totalReactions = (int) $em->createQuery('SELECT COUNT(r.id) FROM App\Entity\PostReaction r')->getSingleScalarResult();
